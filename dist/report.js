(() => {
  ...
  var requestOrgStore = ko.observableArray([]);
...
`;
  ...
  // src/primitives/defaultComponents.js
  ...
  var BaseComponent = class {
    ...
    static template = html3`<div>No Component Registered!</div>`;
  };

  // src/components/AssignmentActions/ApprovalTemplate.js
  var approvalTemplate = html3`
...
`;
  ...
  var constrainedEntityEditTemplate = html3`
  <div>
...
`;
  ...
  var constrainedEntityViewTemplate = html3`
  <div>
...
`;
  ...
  var pendingRequestsIngestTemplate = html3`
...
`;
  ...
  var closedRequestsTableTemplate = html3`
  <div data-bind="">
    <div class="d-flex justify-content-between">
...
`;
  ...
  var openOfficeRequestsTableTemplate = html3`
  <div data-bind="">
    <div class="d-flex justify-content-between">
      <h2 class="mx-0" data-bind="text: filter.Title"></h2>
      <i class="fa fa-sync pointer" data-bind="click: refresh"></i>
...
`;
  ...
  var openRequestsTableTemplate = html3`
  <div data-bind="">
    <div class="d-flex justify-content-between">
      <h2 class="mx-0" data-bind="text: filter.Title"></h2>
      <i class="fa fa-sync pointer" data-bind="click: refresh"></i>
...
`;
  ...
  var requestsByServiceTypeTemplate = html3`
  <select
    class="form-select"
...
`;
  ...
  var requestsByServiceTypeTableTemplate = html3`
...
`;
  ...
  var myAssignmentsTemplate = html3`
  <table
...
`;
  ...
  var requestHeaderEditTemplate = html3`
...
`;
  ...
  var requestHeaderViewTemplate = html3`
  <div class="container-fluid">
    <div class="row">
      <div class="col-6">
        <h6>Request Status:</h6>
...
`;
  ...
  var newAssignmentTemplate = html3`
...
`;
  ...
  var emailRequestTemplate = html3`
  <button
...
`;
  ...
  var generateEmailTemplate = html3`
  <!-- ko if: assignment.Status != assignmentStates.Completed -->
  <div class="card m-1">
    <div class="card-body">
      <div>
...
Full Name: 	${this.serviceType.FieldMap.FullName.toString()}Employee Type: 	${this.serviceType.FieldMap.EmployeeType.toString()}`;
  ...
  var govirtualEditTemplate = html3`
  <div>
...
`;
  ...
  var chOvertimeViewTemplate = html3`
...
`;
  ...
  var chOvertimeEditTemplate = html3`
  <div data-bind="using: FieldMap">
    <div class="row">
      <div
        class="col pb-2"
...
`;
  ...
  var govManagerActionsTemplate = html3`
  <div class="card m-1">
    <div class="card-body">
...
`;
  ...
  var diplomaticPassportEditTemplate = html3`
  <div>
...
`;
  ...
  var diplomaticPassportViewTemplate = html3`
  <div>
    <div class="row row-cols-2" data-bind="using: FieldMap">
      <div
        class="col pb-2"
...
`;
  ...
  var fiscalIrregEditTemplate = html3`
  <div>
...
`;
  ...
  var itSoftwareViewTemplate = html3`
  <div>
...
`;
  ...
  var createProcurementTemplate = html3`
  <!-- ko if: assignment.Status != assignmentStates.Completed -->
  <div class="card m-1">
    <div class="card-body">
      <div>
...
`;
  ...
  var propSpaceEditTemplate = html3`
  <div>
    <div class="row row-cols-2" data-bind="foreach: FormFields">
      <div
        class="col pb-2"
...
`;
  ...
  var propSpaceViewTemplate = html3`
  <div>
    <div class="row row-cols-2" data-bind="foreach: FormFields">
      <div
        class="col pb-2"
...
`;
  ...
  var templateViewTemplate = html3`
  <div>
    <div class="row row-cols-2" data-bind="foreach: FormFields">
      <div
        class="col pb-2"
...
`;
  ...
  var templateEditTemplate = html3`
  <div>
    <div class="row row-cols-2" data-bind="foreach: FormFields">
      <div
        class="col pb-2"
  ...
  var ServiceTypeSummary = class {
    ...
    NotMeetingStandard = ko.pureComputed(() => {
      return this.requests.filter(
        (request2) => !request2.Reporting.MeetingStandard()
      );
    });
    PercentMeetingStandard = ko.pureComputed(
      () => this.MeetingStandardCount() ? Math.round(this.MeetingStandardCount() / this.requests.length * 100) : ""
    );
    ...
    ViewButtonText = ko.pureComputed(
      () => this.ViewLate() ? "Hide Late IDs" : `View ${this.NotMeetingStandard().length} Late IDs`
    );
    ViewLate = ko.observable(false);
    toggleViewLate = () => this.ViewLate(!this.ViewLate());
    totalCompletionTime = () => this.requests.reduce(
      (accumulator, request2) => accumulator + request2.Reporting.OpenDays(),
      0
    );
  ...
  var Report = class _Report {
    ...
    filters = {
      ...
      user: {
        ...
        Options: ko.pureComputed(() => {
          ...
          return assignees.filter(
            (assignee, index, self) => assignee && index === self.findIndex((t) => t?.ID === assignee.ID)
          ).sort(sortByTitle);
        })
      },
      ...
      startDate: new DateField({
        ...
        type: dateFieldTypes.date,
        Visible: ko.pureComputed(
          () => this.filters.status.Value() == requestStates.fulfilled && !this.filters.allDates.Value()
        )
      }),
      endDate: new DateField({
        displayName: "End Date",
    ...
    OrgServiceTypes = ko.pureComputed(
      () => serviceTypeStore().filter(
        (serviceType) => serviceType.Active && serviceType.ReportingOrgs.find(
    ...
    FilteredRequests = ko.pureComputed(() => {
      let filteredRequests = this.allRequests.filter(
        (request2) => request2.State.Status() == this.filters.status.Value()
      );
      if (this.filters.user.Value()) {
        const userId = this.filters.user.Value().ID;
        const requestIds = /* @__PURE__ */ new Set();
        this.allAssignments.filter((assignment) => assignment.Assignee?.ID === userId).map((assignment) => requestIds.add(assignment.Request.ID));
        filteredRequests = filteredRequests.filter(
          (request2) => requestIds.has(request2.ID)
        );
      }
      if (this.filters.status.Value() == requestStates.open || this.filters.allDates.Value()) {
      ...
      return filteredRequests.filter(
        (request2) => filterStart <= request2.Dates.Closed.Value()?.getTime() && request2.Dates.Closed.Value()?.getTime() <= filterEndDate
      );
    });
    FilteredAssignments = ko.pureComputed(() => {
      return this.FilteredRequests().flatMap((request2) => {
        return this.allAssignments.filter(
          (assignment) => assignment.Request.ID == request2.ID
        );
      });
    ...
    ServiceTypeReports = ko.pureComputed(() => {
      ...
      this.OrgServiceTypes().map((service) => {
        const requests = this.FilteredRequests().filter(
          (request2) => service.ID == request2.RequestType.ID
        );
        const requestIds = requests.map((request2) => request2.ID);
